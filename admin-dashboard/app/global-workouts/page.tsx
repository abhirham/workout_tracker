                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <div className="flex items-center justify-end gap-3">
                      <button
                        ...
                        className="text-[#64748B] hover:text-[#2563EB] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                      ...
                      <button
                        ...
                        disabled={deletingId === workout.id}
                        className="text-[#64748B] hover:text-[#DC2626] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
