      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-16 h-16 bg-[#2563EB] rounded-2xl flex items-center justify-center mb-4">
              <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-white">
                <path
                  d="M6.5 6.5h11M6.5 17.5h11M3 12h18M6.5 6.5l-3.5 5.5 3.5 5.5M17.5 6.5l3.5 5.5-3.5 5.5"
                  stroke="currentColor"
                  strokeWidth="2.5"
                  strokeLinecap="round"
            ...
            <h1 className="text-[28px] font-bold text-[#000000]">FitAdmin</h1>
            <p className="text-[14px] text-[#64748B] mt-2 text-center">
              Admin Dashboard for Workout Management
            </p>
          </div>

          {/* Admin Notice */}
          <div className="bg-[#DBEAFE] border border-[#93C5FD] rounded-lg p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-[13px] font-semibold text-[#1E40AF]">Admin Access Only</p>
                <p className="text-[12px] text-[#1E40AF] mt-1">
                  This dashboard is restricted to administrators. Regular users should use the mobile app.
                </p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-white border-2 border-[#E2E8F0] rounded-lg text-[15px] font-semibold text-[#000000] hover:bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isSigningIn ? (
              <>
